<table border="0" width="500" cellspacing="0" cellpadding="0">
		...
		<td>
			...
			<form action="/content.cfm?action=submit_aansluiting_wijzigen_form" method="post" name="aansluiting_wijzigen_form">
			...
			<tr>
				...
				<tr class="cellLichtGrijs">
					...
					<td colspan="1" class="pageText" align="right">
						<a href="Javascript:document.aansluiting_wijzigen_form.submit()">Verzend</a>
					</td>
					<td colspan="1" class="pageText" align="right">
						<a href="Javascript:document.aansluiting_wijzigen_form.reset()">Wis</a>
					</td>
					<td colspan="1" class="pageText" align="right">
							...
							<table border="0" cellspacing="0" width="100%">
								<tbody><tr align="left">
									...
									<td align="left" class="pageText" width="27%" valign="middle">
										<a onclick="window.open('content.cfm?action=viewaansluitpunt&amp;pagelet=true&amp;aansluitpunt=' + document.aansluiting_wijzigen_form.aansluitpunt.value + '&amp;a_nummer=' + document.aansluiting_wijzigen_form.a_nummer.value, '', 'scrollbars,menubar=no,toolbar=no,width=530,height=450');"><img src="images/info-knop2.gif" width="28" height="27" alt="" border="0"></a>
									</td>
								</tr>
							</tbody></table>
						</td>
