<table border="0" width="500" cellspacing="0" cellpadding="0">
		...
		<td>
			...
			<form action="/content.cfm?action=submit_datacom_overige_aanvragen_form" method="post" name="datacom_overige_aanvragen_form">
			...
			<tr>
				...
				<tr class="cellLichtGrijs">
					...
					<td colspan="1" class="pageText" align="right">
						<a href="Javascript:document.datacom_overige_aanvragen_form.submit()">Verzend</a>
					</td>
					<td colspan="1" class="pageText" align="right">
						<a href="Javascript:document.datacom_overige_aanvragen_form.reset()">Wis</a>
					</td>
					<td colspan="1" class="pageText" align="right">
				...
				<table border="0" cellspacing="0" cellpadding="0" align="center" width="460">
					...
					<tr>
						...
						<td colspan="5" align="left" class="pageText">
							<textarea cols="30" rows="5" tabindex="6" name="omschrijving"></textarea>
						</td>
					</tr>
				</tbody></table>
				</td>
