<table border="0" width="500" cellspacing="0" cellpadding="0">
		...
		<td>
			...
			<form action="/content.cfm?action=telecom_submit_aansluiting_verhuizen_form" method="post" name="telecom_aansluiting_verhuizen_form">
			...
			<tr>
				...
				<tr class="cellLichtGrijs">
					...
					<td colspan="1" class="pageText" align="right">
						<a href="Javascript:document.telecom_aansluiting_verhuizen_form.submit()">Verzend</a>
					</td>
					<td colspan="1" class="pageText" align="right">
						<a href="Javascript:document.telecom_aansluiting_verhuizen_form.reset()">Wis</a>
					</td>
					<td colspan="1" class="pageText" align="right">
				...
				<table border="0" cellspacing="0" cellpadding="0" align="center" width="460">
					<tbody><tr class="cell3TD">
						...
						<td colspan="5" align="left" class="pageText">
							...
							&nbsp;&nbsp;&nbsp;<a onclick="window.open('content.cfm?action=viewtel&amp;pagelet=true&amp;searchword=' + document.telecom_aansluiting_verhuizen_form.telefoonnummer.value, '', 'scrollbars,menubar=no,toolbar=no,width=530,height=450');"><img src="images/info-knop2.gif" width="28" height="27" alt="" border="0"></a>
						</td>
					</tr>
					<tr>
							...
							<table border="0" cellspacing="0" width="100%">
								<tbody><tr align="left">
									...
									<td align="left" class="pageText" width="27%" valign="middle">
										<a onclick="window.open('content.cfm?action=viewaansluitpunt&amp;pagelet=true&amp;aansluitpunt=' + document.telecom_aansluiting_verhuizen_form.aansluitpunt.value + '&amp;a_nummer=' + document.telecom_aansluiting_verhuizen_form.a_nummer.value, '', 'scrollbars,menubar=no,toolbar=no,width=530,height=450');"><img src="images/info-knop2.gif" width="28" height="27" alt="" border="0"></a>
									</td>
								</tr>
							</tbody></table>
						</td>
						...
						<td colspan="5" align="left" class="pageText">
							<table border="0" cellspacing="0" width="100%">
								<tbody><tr align="left">
									...
									<td align="left" class="pageText" width="35%" valign="middle"><input type="text" name="nieuwe_aansluitpunt" tabindex="4" size="16" value="" maxlength="10"></td>
									<td align="left" class="pageText" width="3%" valign="middle">&nbsp;&nbsp;&nbsp;</td>
									<td align="left" class="pageText" width="35%" valign="middle"><input type="text" name="nieuwe_a_nummer" tabindex="5" value="" size="3" maxlength="3"></td>
									<td align="left" class="pageText" width="27%" valign="middle">
										<a onclick="window.open('content.cfm?action=viewaansluitpunt&amp;pagelet=true&amp;aansluitpunt=' + document.telecom_aansluiting_verhuizen_form.nieuwe_aansluitpunt.value + '&amp;a_nummer=' + document.telecom_aansluiting_verhuizen_form.nieuwe_a_nummer.value, '', 'scrollbars,menubar=no,toolbar=no,width=530,height=450');"><img src="images/info-knop2.gif" width="28" height="27" alt="" border="0"></a>
									</td>
								</tr>
							</tbody></table>
						</td>
					...
					<tr class="cell3TD">
						...
						<td colspan="5" align="left" class="pageText">
							<input type="text" name="referentie" tabindex="6" size="27" value="" maxlength="20">
						</td>
					</tr>
					<tr>
						<td colspan="1" align="left" class="pageText">
						...
						<td colspan="5" align="left" class="pageText">
							<input type="text" name="uitvoerdatum" tabindex="7" size="16" value="" maxlength="10"> &nbsp;(dd-mm-jjjj)
						</td>
					</tr>
					<tr class="cell3TD">
						<td colspan="1" align="left" class="pageText">
						...
						<td colspan="5" align="left" class="pageText">
							<textarea cols="30" rows="5" tabindex="8" name="omschrijving"></textarea>
						</td>
					</tr>
				</tbody></table>
				</td>
