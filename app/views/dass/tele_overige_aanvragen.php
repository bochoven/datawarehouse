<table border="0" width="500" cellspacing="0" cellpadding="0">
		...
		<td>
			...
			<form action="/content.cfm?action=telecom_submit_overige_aanvragen_form" method="post" name="telecom_overige_aanvragen_form">
			...
			<tr>
				...
				<tr class="cellLichtGrijs">
					...
					<td colspan="1" class="pageText" align="right">
						<a href="Javascript:document.telecom_overige_aanvragen_form.submit()">Verzend</a>
					</td>
					<td colspan="1" class="pageText" align="right">
						<a href="Javascript:document.telecom_overige_aanvragen_form.reset()">Wis</a>
					</td>
					<td colspan="1" class="pageText" align="right">
