<table border="0" width="500" cellspacing="0" cellpadding="0">
		...
		<td>
			...
			<form action="/content.cfm?action=submit_aansluiting_tijdelijk_form" method="post" name="aansluiting_tijdelijk_form">
			...
			<tr>
				...
				<tr class="cellLichtGrijs">
					...
					<td colspan="1" class="pageText" align="right">
						<a href="Javascript:document.aansluiting_tijdelijk_form.submit()">Verzend</a>
					</td>
					<td colspan="1" class="pageText" align="right">
						<a href="Javascript:document.aansluiting_tijdelijk_form.reset()">Wis</a>
					</td>
					<td colspan="1" class="pageText" align="right">
				...
				<table border="0" cellspacing="0" cellpadding="0" align="center" width="460">
							...
							<table border="0" cellspacing="0" width="100%">
								<tbody><tr align="left">
									...
									<td align="left" class="pageText" width="27%" valign="middle">
										<a onclick="window.open('content.cfm?action=viewaansluitpunt&amp;pagelet=true&amp;aansluitpunt=' + document.aansluiting_tijdelijk_form.aansluitpunt.value + '&amp;a_nummer=' + document.aansluiting_tijdelijk_form.a_nummer.value, '', 'scrollbars,menubar=no,toolbar=no,width=530,height=450');"><img src="images/info-knop2.gif" width="28" height="27" alt="" border="0"></a>
									</td>
								</tr>
							</tbody></table>
						</td>
					...
					<tr class="cell3TD">
						<td colspan="1" align="left" class="pageText">
							<table cellpadding="0" cellspacing="0" width="100%">
								<tbody><tr>
									<td class="pageText">Vlan:</td>
								</tr>
							</tbody></table>
						</td>
						<td colspan="5" align="left" class="pageText">
							<input type="text" name="vlan" tabindex="3" value="" size="4" maxlength="4">
						</td>
					</tr>
					<tr>
						<td colspan="1" align="left" class="pageText">
						...
						<td colspan="5" align="left" class="pageText">
							<input type="Checkbox" name="poe" tabindex="4" value="1">
						</td>
					</tr>
					<tr class="cell3TD">
						<td colspan="1" align="left" class="pageText">
					...
					<tr>
						<td colspan="1" align="left" class="pageText">
							<table cellpadding="0" cellspacing="0" width="100%">
								<tbody><tr>
									<td class="pageText">Startdatum:</td>
								</tr>
							</tbody></table>
						</td>
						<td colspan="5" align="left" class="pageText">
							<input type="text" name="startdatum" tabindex="6" value="" size="11" maxlength="10">&nbsp;(dd-mm-jjjj)
						</td>
					</tr>
					<tr class="cell3TD">
						<td colspan="1" align="left" class="pageText">
							<table cellpadding="0" cellspacing="0" width="100%">
								<tbody><tr>
									<td class="pageText">Einddatum:</td>
								</tr>
							</tbody></table>
						</td>
						<td colspan="5" align="left" class="pageText">
							<input type="text" name="einddatum" tabindex="7" value="" size="11" maxlength="10">&nbsp;(dd-mm-jjjj)
						</td>
					</tr>
					<tr class="cell3TD">
						<td colspan="1" align="left" class="pageText">
					...
					<tr>
						...
						<td colspan="5" align="left" class="pageText">
							<input type="text" name="referentie" tabindex="10" size="27" value="" maxlength="20">
						</td>
					</tr>
					<tr class="cell3TD">
						<td colspan="1" align="left" class="pageText">
						...
						<td colspan="5" align="left" class="pageText">
							<textarea cols="30" rows="5" tabindex="11" name="omschrijving"></textarea>
						</td>
					</tr>
				</tbody></table>
				</td>
